...
<body>
	...
	<form action='classNoticeUpdate.do' method='POST'>
		 <div style="margin-top :4vh; margin-left: 4vw; width:70%; height:800px; float: left; overflow: auto; position: relative;">
	        ...
	        <div style="margin:auto; width:70%; height:50px;">
	        	...
	        	<input type="text" class="form-control" style="width:600px; float:left; margin-top:10px;" name="title" id="title" value="${ notice.title }">
	        </div>
	        <div style="width:70%; border-top:1px solid black;margin:auto; margin-top:10px;">
	        	<textarea class="summerNote" id="summernote" name="content" style="padding:10px;">${ notice.content }</textarea>
	        </div>
	        <div style="margin:auto; text-align:center; padding:20px;">
	        	...
	        	<input type="text" id="cnid" name="cnid" value="${ cnid }" style="display:none;">
	        </div>
	     </div>
     </form>
	<script>
