...
<body>
<input type="text" value="${ cNo }" id="cNo" style="display:none;">
    ...
    <div class="flip-card">
      <div class="flip-card-inner">
    	...
    	<div style="width:100%; float:right; padding:10px;">
    		<input type="button" value="돌아가기" class="btn btn-secondary" onclick="location.href='myClass.do?cNo=${cNo}'" style="float:right;">
    	</div>
  </div>
    ...
    $.ajax(
          {
            ...
            url: 'http://192.168.10.13:1222/getOhterClass',
